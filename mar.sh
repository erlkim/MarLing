...
#Install Subs
wget -N -P /var/lib/marzban/templates/subscription/  https://raw.githubusercontent.com/erlkim/MarLing/main/index.html

#install env
wget -O /opt/marzban/.env "https://raw.githubusercontent.com/erlkim/MarLing/main/env"
...
wget -O /usr/bin/profile "https://raw.githubusercontent.com/erlkim/MarLing/main/profile";
chmod +x /usr/bin/profile
apt install neofetch -y
wget -O /usr/bin/cekservice "https://raw.githubusercontent.com/erlkim/MarLing/main/cekservice.sh"
chmod +x /usr/bin/cekservice

#install compose
wget -O /opt/marzban/docker-compose.yml "https://raw.githubusercontent.com/erlkim/MarLing/main/docker-compose.yml"

#Install VNSTAT
apt -y install vnstat
/etc/init.d/vnstat restart
apt -y install libsqlite3-dev
wget https://github.com/erlkim/MarLing/raw/main/vnstat-2.6.tar.gz
...
wget -O /opt/marzban/nginx.conf "https://raw.githubusercontent.com/erlkim/MarLing/main/nginx.conf"
wget -O /opt/marzban/default.conf "https://raw.githubusercontent.com/erlkim/MarLing/main/vps.conf"
wget -O /opt/marzban/xray.conf "https://raw.githubusercontent.com/erlkim/MarLing/main/xray.conf"
mkdir -p /var/www/html
echo "<pre>Setup by AutoScript Bajol</pre>" > /var/www/html/index.html
...
wget -O /var/lib/marzban/xray_config.json "https://raw.githubusercontent.com/erlkim/MarLing/main/xray_config.json"
...
#install database
wget -O /var/lib/marzban/db.sqlite3 "https://github.com/erlkim/MarLing/raw/main/db.sqlite3"
...
echo "Telegram Channel: https://t.me/erlkim" | tee -a log-install.txt
